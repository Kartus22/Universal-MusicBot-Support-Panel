...
- **Playlist Sync:** Automatically generates `.txt` playlist files based on your media folder.
...
Bash
pyinstaller --onefile --noconsole --name "MusicBot_Support_Panel" appexe.py
